...
\]
    \item Search procedure: repeat 1,2,3 below exhaustively
    \begin{enumerate}
    ...
    completeness result:
    \item The search procedure stops in 1 iff $A$ is derivable (\red{if-part!})
    \item Example for un/fairness: $\exists y. s(x,y)$ and $p(0)$
 \end{itemize}
\end{frame}
